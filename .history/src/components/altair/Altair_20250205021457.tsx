...
function AltairComponent() {
  const [solutionText, setSolutionText] = useState<string>(`# Welcome to Apka Mitra! 👋

I'm your personal assistant, ready to help you with anything you need. You can:
...
Just start typing below and I'll be happy to help!`);
